...
| **`02-SECURITY-AUTHN-AUTHZ.md`** | JWT, gateway auth, service-to-service security (short) |
| **`security/`** | **SSO / Keycloak deep dive + runnable demo** |
...
| **`grpc/`** | gRPC overview + runnable server/client demo (not REST) |
